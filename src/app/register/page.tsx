    ...
    <div className="min-h-screen flex w-full font-sans bg-slate-50 dark:bg-slate-950">
        ...
        <div className="w-full max-w-md mx-auto space-y-8">
          ...
          <div className="space-y-6">
            ...
            <p className="text-center text-sm text-slate-600 dark:text-slate-400 font-semibold">
              ...
              <Link href="/login" className="font-extrabold text-emerald-600 dark:text-emerald-400 hover:text-emerald-500 transition-colors">
                Sign in here
              </Link>
            </p>
          </div>
      ...
      <div className="hidden lg:flex flex-1 relative bg-slate-950 items-center justify-center overflow-hidden border-l border-slate-900">
        ...
        <div className="relative z-10 max-w-lg p-12 text-center flex flex-col items-center">
          <div className="w-20 h-20 bg-emerald-500/10 backdrop-blur-md rounded-2xl flex items-center justify-center mx-auto mb-8 border border-white/5 shadow-inner">
            <MoonStar className="w-10 h-10 text-emerald-400" />
          </div>
          
          <h2 className="text-4xl font-extrabold text-white mb-6 leading-tight tracking-tight">Begin Your Digital Islamic Journey</h2>
          ...
          <div className="w-80 bg-white/[0.03] backdrop-blur-md border border-white/10 rounded-2xl p-5 text-left shadow-2xl">
            <div className="flex justify-between items-center mb-4">
              <span className="text-xs font-bold text-emerald-400 tracking-wider uppercase">Active Streak</span>
            ...
            <div className="flex justify-between items-center">
              ...
              <div className="flex items-center gap-2 bg-teal-500/10 border border-teal-500/25 px-2.5 py-1 rounded-full">
                <span className="w-1.5 h-1.5 rounded-full bg-teal-400 animate-pulse" />
                <span className="text-xs font-bold text-teal-300">Habit Streaks</span>
              </div>
            </div>
          </div>
        </div>
